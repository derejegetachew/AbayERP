...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['ViewReport.name', '<?php __('Name'); ?>']
,			['ViewReport.lname', '<?php __('Lname'); ?>']
,			['ViewReport.sex', '<?php __('Sex'); ?>']
,			['ViewReport.phone', '<?php __('Phone'); ?>']
		]
	}),
	mode: 'local',
...
var viewReportSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var viewReportSearchWindow = new Ext.Window({
	title: '<?php __('Search ViewReport'); ?>',
	modal: true,
	items: viewReportSearchForm,
	resizable: false,
	width: 550,
	height: 400,
